...
public class Hospital
{
    ...
    private static void PrintDepartmentRoom(Dictionary<string, List<string[]>> departments, string departmentName, int room)
    {
    ...
    private static void PrintPatientsInDepartment(Dictionary<string, List<string[]>> departments, string departmentName)
    {
